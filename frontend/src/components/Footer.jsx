    ...
    return (
        <footer className="text-gray-500 bg-black px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                ...
                FitHive is your all-in-one fitness hub designed to help you stay consistent, motivated, and healthy. From personalized workout plans to expert wellness tips, we bring everything you need for your fitness journey in one place. Join our hive and take the next step towards a stronger, healthier you.
                </p>
            </div>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2025 Fit Hive All rights reserved.
                </div>
